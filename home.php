...
<body>
<!--<div class="row">
<div class="col-sm-6" align="center" style="background-color:#ffcc99;">
  Welcome
  <b><?php
...
<div align="center" class="col-sm-6" style="background-color:#ccffcc;">
...
<div class="boxfather">
<div class="box">
  <h1 class="box-h1">WELCOME to CryptoType, <?php echo $_SESSION['sess_user']; ?></h1><br>
...
<span class="book not-found">hello&copy;<b style="color:red;"><?php echo $_SESSION['sess_user']; ?></b></span>
...
<h3 style="margin:1%;position:absolute;top:0px;">Howdy, <?php echo $_SESSION['sess_user']; ?> (<a href="logout.php" class="logout" style="text-decoration: none;">LogOut</a>)</h3>
<button type="button" name="start-game" class="start-game btn btn-default"><a href="level1.php" style="text-decoration: none;">START GAME</a></button>
...
<!--<button type="button" name="login" class="login btn btn-info" style="margin:1%;position:absolute;top:0px;left:50%;">LogIn</button>
<button type="button" name="login" class="register btn btn-danger" style="margin:1%;position:absolute;top:0px;right:50%;">Register</button>-->
</div>
